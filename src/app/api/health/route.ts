...
export async function GET(req: NextRequest) {
  const diagnostics: any = {
    env: {
      ...
      MIDTRANS_SERVER_KEY: process.env.MIDTRANS_SERVER_KEY ? process.env.MIDTRANS_SERVER_KEY.substring(0, 14) : "Missing",
      NEXT_PUBLIC_MIDTRANS_CLIENT_KEY: process.env.NEXT_PUBLIC_MIDTRANS_CLIENT_KEY ? process.env.NEXT_PUBLIC_MIDTRANS_CLIENT_KEY.substring(0, 14) : "Missing",
